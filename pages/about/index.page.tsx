		...
		<div className="container mx-auto p-6 max-w-6xl">
			...
			<div className="grid grid-cols-6 gap-6 pt-6">
				<div className="mb-6 lg:mb-0 object-cover col-span-full lg:col-start-1 lg:col-end-4">
					<Image src={aboutMeHeader} alt="Rhodes family photo" />
				</div>
				<div className="col-span-full lg:col-start-4 lg:col-end-7 font-light">
					...
					<p className="mb-4">
						...
						luxury services in a laid back and friendly environment. I’m proud
						to say that I’m able to deliver that experience at Graced Studio.
					</p>
					<p className="mb-4">
					...
					<p className="mb-4">
						...
						possible. We enjoy spending time in the mountains - you can
						typically find us fly fishing in the rivers, or visiting all the
						waterfalls. We have three dogs and a cat, and sometimes I feel like
						we run a small zoo! I am so grateful for the life I live, and I
						thank God every day for bringing me so much joy!
					</p>
					<p className="mb-4">
