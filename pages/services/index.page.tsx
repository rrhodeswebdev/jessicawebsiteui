...
const ServicesPage: React.FC<Props> = (props) => {
	...
	return (
		<section className="container mx-auto max-w-6xl px-4">
			...
			<div className="mb-16">
				<h2 className="text-4xl mb-10 p-4 text-center bg-shade">Styling</h2>
				{services.styling.map((service) => (
					<ServiceInfoBlock service={service} key={service._id} />
				))}
			</div>
			<div className="mb-16">
				<h2 className="text-4xl mb-10 p-4 text-center bg-shade">Color</h2>
				{services.color.map((service) => (
					<ServiceInfoBlock service={service} key={service._id} />
				))}
			</div>
			<div className="mb-16">
				<h2 className="text-4xl mb-10 p-4 text-center bg-shade">Extensions</h2>
				...
				<div className="text-center">
					...
					<p className="font-light border-b border-secondary pb-8">
						I offer a variety of extension methods to create a custom experience
						for each guest. I require an in-person consultation for any new
						extension client. Pricing and method determined during the
						consultation.
					</p>
				</div>
			</div>
